package com.ericsantanna.filemanager.views.fileView.tableView
...
class TableView implements PathView {
    javafx.scene.control.TableView<PathItem> tableView
    ClipboardService clipboardService
    PathViewContextMenuController pathViewContextMenuController

    TableView(javafx.scene.control.TableView<PathItem> tableView, ClipboardService clipboardService, ObservableList<PathItem> data, ObjectProperty<Path> pathProperty, PathViewContextMenuController pathViewContextMenuController, PathService pathService) {
